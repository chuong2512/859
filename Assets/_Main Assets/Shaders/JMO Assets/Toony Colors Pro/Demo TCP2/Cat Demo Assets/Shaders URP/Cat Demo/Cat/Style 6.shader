...
Shader "Toony Colors Pro 2/Examples URP/Cat Demo/Cat/Style 6"
{
	...
	SubShader
	{
		...
		v2f_outline vertex_outline (appdata_outline v)
		{
			...
			half4 value__BaseMap = TCP2_TEX2D_SAMPLE_LOD(_BaseMap, _BaseMap, v.texcoord0.xy, -1).rgba;
		...
		Pass
		{
			...
			half4 Fragment(Varyings input) : SV_Target
			{
				...
				// Custom Material Properties Sampling
				half4 value__BaseMap = TCP2_TEX2D_SAMPLE(_BaseMap, _BaseMap, input.pack1.xy).rgba;
